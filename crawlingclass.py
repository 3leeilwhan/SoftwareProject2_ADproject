...
class Crawling():
    ...
    def todayMenu(self, restaurant):
        if restaurant == "가마중식":
            return self.main()[0]["menu"]["가마중식"][self.weekDay() + 2]
        elif restaurant == "누들송(면)":
            return self.main()[0]["menu"]["누들송(면)중식"][self.weekDay() + 2]
        elif restaurant == "인터쉐프중식":
            return self.main()[0]["menu"]["인터쉐프중식"][self.weekDay() + 2]
        elif restaurant == "데일리밥중식":
            return self.main()[0]["menu"]["데일리밥중식"][self.weekDay() + 2]


if __name__ == "__main__":
    print(Crawling().todayMenu("가마중식"))
